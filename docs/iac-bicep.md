...
Re-running with the same input does **nothing** if reality already matches. This is called "idempotent," and it's what makes it safe to run repeatedly (e.g., on every push to `main`).
